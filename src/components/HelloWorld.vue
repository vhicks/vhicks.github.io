...
export default {
  ...
  var chicago = addCity({ "latitude": 41.8781, "longitude": -87.6298 }, "Chicago");
  var barcelona = addCity({ "latitude": 41.3851, "longitude": 2.1734 }, "Barcelona");
  var ibiza = addCity({ "latitude": 39.0200, "longitude": 1.4821 }, "Ibiza");
  ...
  addLine(chicago,barcelona);
  addLine(barcelona,ibiza);
  addLine(ibiza,madrid);
  // addLine(madrid,barcelona);
